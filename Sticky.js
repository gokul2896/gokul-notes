const containerElement=document.getElementById("box_container");
const btnAdd=document.getElementsByClassName("btn_container")[0];


function getAppStorage(){
  return JSON.parse(localStorage.getItem("gokul-sticky-app") || "[]");
}
...
function saveNotes(notes){
  localStorage.setItem("gokul-sticky-app",JSON.stringify(notes));
}
